    ...
    def _rows_to_conversation(
        ...
        *,
        ...
        for row in rows:
            ...
            # NOTE: timestamp is intentionally NOT forwarded in this format.
            ...
            # _row_id above already provides durable message identity for
            # reactions — no need to also expose the DB ordering key.
